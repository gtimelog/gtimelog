...
from gtimelog.utils import as_minutes, as_hours, format_duration_short, format_duration_long, parse_datetime, \
    virtual_day, different_days, first_of_month, next_month, get_mtime
