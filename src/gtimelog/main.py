...
class Window(Gtk.ApplicationWindow):
    ...
    def __init__(self, app):
        ...
        self.custom_range_revealer = builder.get_object("custom_range_revealer")
        ...
        self.bind_property('custom_time_range', self.custom_range_revealer, 'reveal-child', GObject.BindingFlags.DEFAULT)
